...
radius = 70
angle1 = 60*math.pi/180  # Angle between 1st and 2nd finger in radian
angle2 = 300*math.pi/180  # Angle between 1st and 3rd finger in radian
angle3 = 180*math.pi/180  # Angle between 1st and 4th finger in radian
...
def createScene(rootNode):
    ...
    for i in range(4):
        ...
        if i == 0:
            ...
            finger.addObject('BoxROI', name='boxROISubTopo', box=[-60, -4, -20, 60, 0, 20], strict=False, drawBoxes =True, drawSize = 1) #
